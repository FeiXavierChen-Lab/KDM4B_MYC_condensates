...
if ls ${bw_track_dir}/*bw >/dev/null 2>&1; then
    ...
    echo -e "The TT-seq pipeline for datainfo ${datainfo} has completed successfully.\n
            ...
            python ${file_path}/sendmail.py ${email} "TT-seq Pipeline Complete"
fi
